...
def main():
    ...
    manifest = sciviz.finalize(
        ...
        note=(
            ...
            "del área exportada. La señal confirmada W5 corresponde a "
            ...
            "sectores de Ancón y Carabayllo 2 no se representan porque registran "
            "0 y 4 píxeles respectivamente; Ancón aporta el 90 % de la superficie "
            "del ACR y no presenta ninguna de las dos señales. Carabayllo 1 "
